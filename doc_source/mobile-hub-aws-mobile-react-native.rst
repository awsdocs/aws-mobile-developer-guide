...
.. _mobile-hub-aws-mobile-react-native:
...
.. meta::
    :description:
        Use React Native to create, build, test and monitor mobile apps that are
...
.. toctree::
    ...
    Get Started <mobile-hub-react-native-getting-started>
    Reference <mobile-hub-react-native-aws-mobile-reference>
