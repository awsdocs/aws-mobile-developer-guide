...
.. note:: For the :code:`saveRecord()` request above to work, you would have to have created a
   ...
   <https://console.aws.amazon.com/kinesis>`__.
...
<http://aws.amazon.com/kinesis/developer-resources/>`__. To learn more about the Kinesis classes, see
the `API Reference for the Android SDK <http://docs.aws.amazon.com/AWSAndroidSDK/latest/javadoc/>`__.
...
<http://docs.aws.amazon.com/AWSAndroidSDK/latest/javadoc/>`__.
