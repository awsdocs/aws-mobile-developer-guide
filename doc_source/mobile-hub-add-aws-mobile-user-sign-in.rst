...
.. container:: option
   ...
   Email & Password
      ...
      #. Follow the :ref:`Set up Email & Password Login <mobile-hub-set-up-email-and-password>` steps to connect to your backend from your app.
   ...
   Facebook
      ...
      #. Follow the steps at :ref:`Set Up Facebook Login <mobile-hub-set-up-facebook>` to connect to your backend from your app.
   ...
   Google
      ...
      #. Follow the steps at :ref:`Set Up Google Login <mobile-hub-set-up-google>` to connect to your backend from your app.


.. _mobile-hub-set-up-email-and-password:
